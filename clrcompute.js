function rgbToHex(r, g, b) {
  ...
  function compute() {
    const input = document.getElementById('clr').value;
    ...
    fill.innerText = res.result.filter;
    fill.parentElement.setAttribute("data-clipboard-text", res.result.filter);
  ...
  function onStart() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
      document.getElementById('clr').removeAttribute('disabled');
    });
  }
